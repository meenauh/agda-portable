...
[Combining dependency sort and priority tiers. Design the required GDD set in
this order, then review the whole set together before architecture begins.]
...
- [ ] Design the required MVP/foundation/high-risk GDD set
- [ ] Run batch design review on the required GDD set
