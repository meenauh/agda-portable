...
## Risks and Validation Decisions
...
[Decisions required before approval should be asked and resolved during the process. Record only resolved validation paths here.]
