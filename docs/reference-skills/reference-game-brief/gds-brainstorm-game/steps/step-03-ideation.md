...
- Present the REFINE/CONTINUE menu after ideation session
- ONLY proceed when user chooses CONTINUE
- Update frontmatter `stepsCompleted: [1, 2, 3]` before loading next step

## EXPLORATION & COLLABORATION MENU:

- **REFINE**: Go deeper on promising ideas, weak concepts, missing player motivations, or unclear core loops.
- **CONTINUE**: Save ideas and move to organization phase.
...
**Select an Option:**
REFINE - Go deeper on a promising idea, weak area, or missing angle
CONTINUE - Save what we have and move forward"
...
**Select an Option:**
REFINE - Go deeper on a specific concept, weak area, or missing angle
CONTINUE - Save this and move to organization (Step 4 of 4)
...
ONLY WHEN [CONTINUE option] is selected and [ideation content saved with frontmatter updated], will you then load and read fully `{nextStepFile}`.
...
- Not presenting REFINE/CONTINUE menu after ideation
