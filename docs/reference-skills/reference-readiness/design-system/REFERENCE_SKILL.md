...
### Optional Sections: Visual/Audio, UI Requirements, Resolved Decisions
...
- "The 8 required sections are complete. Do you want to also define Visual/Audio
  requirements, UI requirements, or capture resolved decisions?"
  - Options: "Yes, all three", "Just Resolved Decisions", "Skip — I'll add these later"
...
For **Resolved Decisions**: Capture anything that came up during design that wasn't
